 ...
 * whenever the configured time, MAX_AGE,  has passed. The unit is 4us.
 ...
 * Bit 2: Group 2 - Ingress service counters.
 * Bit 3: Group 3 - Egress service counters.
 *
 ...
 * register.
 * For groups 0-1, STAT_VIEW defines the port to read counters for.
 * For groups 2-3, STAT_VIEW defines the service index to read counters
 * for.
