 ...
 * not modified since the global configuration registers are not reset to
 * default settings.  The global configuration registers are
 * 1Ex0000-1Ex7FFF and 1Ex8100-1Ex83FF.
...
/** 
 * \brief Data to GPIO output driver
 *
 * \details
 * Register: \a VENICE_GLOBAL:Pin_Status:GPIO_data_out
 */
#define VTSS_VENICE_GLOBAL_Pin_Status_GPIO_data_out  VTSS_IOREG(0x1e, 0, 0x0005)


/** 
 * \brief GPIO output driver's tri-state control
 *
 * \details
 * Register: \a VENICE_GLOBAL:Pin_Status:GPIO_tri
 */
#define VTSS_VENICE_GLOBAL_Pin_Status_GPIO_tri  VTSS_IOREG(0x1e, 0, 0x0006)
 ...
 * register * 12.8 nS.	All interrupt_pending registers in both channels
 * use this common value except LOPC_interrupt_pend in 1xA200.0
 *
 * \details 
 ...
 * 10: Drive repeating LOW/Hi-Z pattern at 2Hz.
 * 11: Drive repeating LOW/Hi-Z pattern at 5Hz.
 * 
 ...
 * interrupt pending generation in 2xEE04.15 is:
 * 0: Disabled
 * 1: Enabled
 *
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL_F2DF_DFT_F2DF_DFTMAIN_STAT_2 . STUCK_AT
 */
#define  VTSS_F_VENICE_GLOBAL_F2DF_DFT_F2DF_DFTMAIN_STAT_2_STUCK_AT  VTSS_BIT(4)
 ...
 *
 * Register: \a VENICE_GLOBAL:RCOMP_CFG:RCOMP_CFG0
 */
#define VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0  VTSS_IOREG(0x1e, 0, 0x7000)

/** 
 * \brief
 * Disable direct use of Resistor comparator value
 *
 * \details 
 * 0:normal operation

 *
 * Field: VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0 . RCOMP_DISTR_DIS
 */
#define  VTSS_F_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_RCOMP_DISTR_DIS  VTSS_BIT(14)
 ...
 * 1: enable power-down
 *
 * Field: VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0 . PWD_ENA
 */
#define  VTSS_F_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_PWD_ENA  VTSS_BIT(13)
 ...
 * 1: start (activate)
 *
 * Field: VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0 . RUN_CAL
 */
#define  VTSS_F_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_RUN_CAL  VTSS_BIT(12)
 ...
 * 3: max period/8
 *
 * Field: VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0 . SPEED_SEL
 */
#define  VTSS_F_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_SPEED_SEL(x)  VTSS_ENCODE_BITFIELD(x,10,2)
#define  VTSS_M_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_SPEED_SEL     VTSS_ENCODE_BITMASK(10,2)
#define  VTSS_X_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_SPEED_SEL(x)  VTSS_EXTRACT_BITFIELD(x,10,2)
 ...
 *
 * Field: VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0 . MODE_SEL
 */
#define  VTSS_F_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_MODE_SEL(x)  VTSS_ENCODE_BITFIELD(x,8,2)
#define  VTSS_M_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_MODE_SEL     VTSS_ENCODE_BITMASK(8,2)
#define  VTSS_X_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_MODE_SEL(x)  VTSS_EXTRACT_BITFIELD(x,8,2)
 ...
 * 1: overwrite mode
 *
 * Field: VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0 . FORCE_ENA
 */
#define  VTSS_F_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_FORCE_ENA  VTSS_BIT(4)
 ...
 *
 * Field: VTSS_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0 . RCOMP_VAL
 */
#define  VTSS_F_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_RCOMP_VAL(x)  VTSS_ENCODE_BITFIELD(x,0,4)
#define  VTSS_M_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_RCOMP_VAL     VTSS_ENCODE_BITMASK(0,4)
#define  VTSS_X_VENICE_GLOBAL_RCOMP_CFG_RCOMP_CFG0_RCOMP_VAL(x)  VTSS_EXTRACT_BITFIELD(x,0,4)
