...
/** 
 * \brief
 * Pls. refer to PHYS_SRC_AGGR_CFG.PHYS_SRC_AGGR_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Pls. refer to STACK_CFG.STACK_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Pls. refer to STACK_A_CFG.STACK_A_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Disable ISDX count from stacking ports 
 *
 * \details 
...
/** 
 * \brief
 * Allow FWD_LOGICAL internal port number control from MAC table
 *
 * \details 
 * 0: Disable (send intpn=15)
 * 1: Enable Enable (send intpn=returned from mac table)
 *
...
/** 
 * \brief
 * Allow routing of all VSTAX frames forwarded as FWD_LOGICAL with UPSID =
 * COMMON_VSTAX_CFG.OWN_UPSID
 *
 * \details 
 * 0: Disable (allow only routing of FWD_LOGICAL if dst_port_type ==
 * port_type_intpn and dst_pn == intpn_dlookup or dst_pn == intpn_dlookup)
 * 1: Enable
 *
...
/** 
 * \brief
 * Enable / disable putting DSCP into VSTAX MISC field when encoding as AC.
 *
 * \details 
 * 0: Disable 
...
/** 
 * \brief
 * Controls flooding to equal cost stack.
 * 
 * If forwarding tables are configured such that flooding will forward
 * either one or the other way around the ring, then setting this bit will
 * cause the TTL configured in VSTAX2_EQUAL_STACK_LINK_TTL_VAL to be used.
 * 
 ...
 * \details 
 * 0: Disable
 * 1: Enable (flooding using ANA_AC::VSTAX2_EQUAL_STACK_LINK_TTL_VAL)
 *
...
/** 
 * \brief
 * Pls. refer to VSTAX_GMIRROR_CFG.GMIRROR_PORT_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Pls. refer to PROBE_PORT_CFG.PROBE_PORT_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Pls. refer to AGGR_CFG.PORT_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Pls. refer to SRC_CFG.PORT_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Pls. refer to UPSID_CFG.UPSID_PORT_MASK description.
 *
 * \details 
...
/** 
 * \brief
 * Pls. refer to PGID_CFG.PORT_MASK description.
 *
 * \details 
 ...
 * discarded
 *  Bit1: Count frontport traffic applicable for ACL policer but not
 * discarded
 *  Bit2: Count CPU traffic discarded by ACL policer
 *  Bit3: Count frontport traffic discarded by ACL policer 
 *
 * \details 
 * If an asserted event is masked out in the GLOBAL_EVENT_MASK, the
 * incoming frame should not be counted for all flows.
