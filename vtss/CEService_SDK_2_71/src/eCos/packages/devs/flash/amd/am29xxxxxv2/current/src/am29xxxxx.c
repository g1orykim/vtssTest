...
#define AM29_COMMAND_PROGRAM_BUFFER          AM29_SWAP(AM29_PARALLEL(0x0029))
#define AM29_COMMAND_LOAD_BUFFER             AM29_SWAP(AM29_PARALLEL(0x0025))
...
#define AM29_OFFSET_CFI_WR_BUF_SZ_LSB           AM29_OFFSET_CFI_DATA(0x002A)
#define AM29_OFFSET_CFI_WR_BUF_SZ_MSB           AM29_OFFSET_CFI_DATA(0x002B)
