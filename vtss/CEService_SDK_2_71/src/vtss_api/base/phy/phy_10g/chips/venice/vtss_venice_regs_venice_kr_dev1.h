 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_cfg0_tr_cfg0 . apc_drct_en
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_cfg0_tr_cfg0_apc_drct_en  VTSS_BIT(11)
 ...
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_cfg1_tr_cfg1_tmr_hold(x)  VTSS_ENCODE_BITFIELD(x,0,9)
#define  VTSS_M_VENICE_KR_DEV1_tr_cfg1_tr_cfg1_tmr_hold     VTSS_ENCODE_BITMASK(0,9)
#define  VTSS_X_VENICE_KR_DEV1_tr_cfg1_tr_cfg1_tmr_hold(x)  VTSS_EXTRACT_BITFIELD(x,0,9)
...
/** 
 * \brief
 * initial settings for local transmitter.
 *
 * \details 
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_ber_ofs_tr_ber_ofs . ber_ofs
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_ber_ofs_tr_ber_ofs_ber_ofs(x)  VTSS_ENCODE_BITFIELD(x,0,6)
#define  VTSS_M_VENICE_KR_DEV1_tr_ber_ofs_tr_ber_ofs_ber_ofs     VTSS_ENCODE_BITMASK(0,6)
#define  VTSS_X_VENICE_KR_DEV1_tr_ber_ofs_tr_ber_ofs_ber_ofs(x)  VTSS_EXTRACT_BITFIELD(x,0,6)
 ...
 *
 * \details
 * Register: \a VENICE_KR_DEV1:tr_brkmask:tr_brkmask_msw
 */
#define VTSS_VENICE_KR_DEV1_tr_brkmask_tr_brkmask_msw  VTSS_IOREG(0x01, 0, 0x8214)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_brkmask_tr_brkmask_msw . brkmask_msw
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_brkmask_tr_brkmask_msw_brkmask_msw(x)  VTSS_ENCODE_BITFIELD(x,0,16)
#define  VTSS_M_VENICE_KR_DEV1_tr_brkmask_tr_brkmask_msw_brkmask_msw     VTSS_ENCODE_BITMASK(0,16)
#define  VTSS_X_VENICE_KR_DEV1_tr_brkmask_tr_brkmask_msw_brkmask_msw(x)  VTSS_EXTRACT_BITFIELD(x,0,16)

/**
 * Register Group: \a VENICE_KR_DEV1:tr_romadr
 *
 * Not documented
 */
 ...
 *
 * \details
 * Register: \a VENICE_KR_DEV1:tr_romadr:romadr1
 */
#define VTSS_VENICE_KR_DEV1_tr_romadr_romadr1  VTSS_IOREG(0x01, 0, 0x8220)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_romadr_romadr1 . romadr_gain1
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_romadr_romadr1_romadr_gain1(x)  VTSS_ENCODE_BITFIELD(x,7,7)
#define  VTSS_M_VENICE_KR_DEV1_tr_romadr_romadr1_romadr_gain1     VTSS_ENCODE_BITMASK(7,7)
#define  VTSS_X_VENICE_KR_DEV1_tr_romadr_romadr1_romadr_gain1(x)  VTSS_EXTRACT_BITFIELD(x,7,7)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_romadr_romadr1 . romadr_gain2
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_romadr_romadr1_romadr_gain2(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_VENICE_KR_DEV1_tr_romadr_romadr1_romadr_gain2     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_VENICE_KR_DEV1_tr_romadr_romadr1_romadr_gain2(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 *
 * \details
 * Register: \a VENICE_KR_DEV1:tr_romadr:romadr2
 */
#define VTSS_VENICE_KR_DEV1_tr_romadr_romadr2  VTSS_IOREG(0x01, 0, 0x8221)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_romadr_romadr2 . romadr_dfe1
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_romadr_romadr2_romadr_dfe1(x)  VTSS_ENCODE_BITFIELD(x,7,7)
#define  VTSS_M_VENICE_KR_DEV1_tr_romadr_romadr2_romadr_dfe1     VTSS_ENCODE_BITMASK(7,7)
#define  VTSS_X_VENICE_KR_DEV1_tr_romadr_romadr2_romadr_dfe1(x)  VTSS_EXTRACT_BITFIELD(x,7,7)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_romadr_romadr2 . romadr_dfe2
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_romadr_romadr2_romadr_dfe2(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_VENICE_KR_DEV1_tr_romadr_romadr2_romadr_dfe2     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_VENICE_KR_DEV1_tr_romadr_romadr2_romadr_dfe2(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 *
 * \details
 * Register: \a VENICE_KR_DEV1:tr_romadr:romadr3
 */
#define VTSS_VENICE_KR_DEV1_tr_romadr_romadr3  VTSS_IOREG(0x01, 0, 0x8222)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_romadr_romadr3 . romadr_ber1
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_romadr_romadr3_romadr_ber1(x)  VTSS_ENCODE_BITFIELD(x,7,7)
#define  VTSS_M_VENICE_KR_DEV1_tr_romadr_romadr3_romadr_ber1     VTSS_ENCODE_BITMASK(7,7)
#define  VTSS_X_VENICE_KR_DEV1_tr_romadr_romadr3_romadr_ber1(x)  VTSS_EXTRACT_BITFIELD(x,7,7)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_romadr_romadr3 . romadr_ber2
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_romadr_romadr3_romadr_ber2(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_VENICE_KR_DEV1_tr_romadr_romadr3_romadr_ber2     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_VENICE_KR_DEV1_tr_romadr_romadr3_romadr_ber2(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 *
 * \details
 * Register: \a VENICE_KR_DEV1:tr_romadr:romadr4
 */
#define VTSS_VENICE_KR_DEV1_tr_romadr_romadr4  VTSS_IOREG(0x01, 0, 0x8223)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_romadr_romadr4 . romadr_end
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_romadr_romadr4_romadr_end(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_VENICE_KR_DEV1_tr_romadr_romadr4_romadr_end     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_VENICE_KR_DEV1_tr_romadr_romadr4_romadr_end(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_KR_DEV1_tr_sts1_tr_sts1 . lptrain_sm
 */
#define  VTSS_F_VENICE_KR_DEV1_tr_sts1_tr_sts1_lptrain_sm(x)  VTSS_ENCODE_BITFIELD(x,4,5)
#define  VTSS_M_VENICE_KR_DEV1_tr_sts1_tr_sts1_lptrain_sm     VTSS_ENCODE_BITMASK(4,5)
#define  VTSS_X_VENICE_KR_DEV1_tr_sts1_tr_sts1_lptrain_sm(x)  VTSS_EXTRACT_BITFIELD(x,4,5)
