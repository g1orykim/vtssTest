...
#ifndef _DHCP_RELAY_CLI_H_
#define _DHCP_RELAY_CLI_H_

/**
 * \file dhcp_relay_cli.h
 * \brief This file defines the interface to the DHCP relay module's CLI commands.
 */
