 ...
 * soft-reset, for more info see RESET.CORE_RST_PROTECT inside the VCore
 * register space.
 *
 * \details 
 ...
 * the corresponding dev2g5 (see DEVCPU_GCB::HW_CFG.DEV10G_n_MODE for more
 * information.)
 *
 * \details 
 ...
 * after setting this field ICPU_CFG::TEMP_SENSOR_STAT.TEMP_VALID will be
 ...
 * ICPU_CFG::TEMP_SENSOR_STAT.TEMP.
 *
 * \details 
 ...
 * ICPU_CFG::TEMP_SENSOR_STAT.TEMP_VALID is set. This field is continually
 * updated (approximately every 200us) while the termperature sensor is
 * enabled, see ICPU_CFG::TEMP_SENSOR_CTRL.RST for more information.
 *
 * \details 
 ...
 * busy DEVCPU_GCB::MEMITGR_MODE.MODE_BUSY is set).
 * From IDLE (DEVCPU_GCB::MEMITGR_MODE.MODE_IDLE is set) the monitor can
 ...
 * to LISTEN mode.
 * From DETECT (DEVCPU_GCB::MEMITGR_MODE.MODE_DETECT is set) the monitor
 ...
 * From LISTEN (DEVCPU_GCB::MEMITGR_MODE.MODE_LISTEN is set) the monitor
 ...
 * (DEVCPU_GCB::MEMITGR_MODE.MODE_LISTEN is set), in all other states
...
/** 
 * \brief
 * This field is valid only when DEVCPU_GCB::MEMITGR.MEM_ERR or
 * DEVCPU_GCB::MEMITGR.MEM_COR is set.
 *
 * \details 
 ...
 * currently provided in DEVCPU_GCB::MEMITGR_MEMINFO. Indexes are counted
 * from 1 (not 0).
 *
 * \details 
