...
/* peter, 2007/6, move SNMP/eCos default supported MIB II to EstaX-34 management module */
//peter #include "mibgroup/mibII/system_mib.h"  // { mib2 1 }
//peter #include "mibgroup/mibII/sysORTable.h"  // { mib2 1.9.1 } == { system 9.1 }
//peter #include "mibgroup/mibII/interfaces.h"  // { mib2 2 }
//#include "mibgroup/mibII/at.h"        // #3 is deprecated
//peter #include "mibgroup/mibII/ip.h"          // { mib2 4 }
//peter #include "mibgroup/mibII/icmp.h"        // { mib2 5 }
//peter #include "mibgroup/mibII/tcp.h"         // { mib2 6 }
//peter #include "mibgroup/mibII/udp.h"         // { mib2 7 }
//peter #include "mibgroup/mibII/dot3.h"        // { mib2 10.7 } == { transmission 7 }
//peter #include "mibgroup/mibII/snmp_mib.h"    // { mib2 11 }
