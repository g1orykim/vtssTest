...
#define CYGNUM_CALL_IF_GET_PERSIST_DATA           24

#define CYGNUM_CALL_IF_LAST_ENTRY                 CYGNUM_CALL_IF_GET_PERSIST_DATA
...
typedef size_t (__call_if_get_persist_data_t)(cyg_persist_data_t *p);
...
#define CYGNUM_CALL_IF_FLASH_FIS_GET_LOADED_ENTRY (7)
...
#define CYGACC_CALL_IF_GET_PERSIST_DATA(_b_) \
 CYGACC_CALL_VV1(__unused__, CYGNUM_CALL_IF_GET_PERSIST_DATA, (_b_))
__call_VV1(CYGNUM_CALL_IF_GET_PERSIST_DATA, __call_if_get_persist_data_t, size_t, cyg_persist_data_t *)
#define CYGACC_CALL_IF_GET_PERSIST_DATA_SET(_x_) \
 hal_virtual_vector_table[CYGNUM_CALL_IF_GET_PERSIST_DATA]=(CYG_ADDRWORD)(_x_)
