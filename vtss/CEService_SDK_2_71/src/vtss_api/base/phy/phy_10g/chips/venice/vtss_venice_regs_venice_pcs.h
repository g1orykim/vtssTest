...
/** 
 * \details 
 * 0: Fault condition not detected.  (PCS receive local fault (3x0008.10) =
 * 0) AND (PCS transmit local fault (3x0008.11) = 0)
 * 1: Fault condition detected. (PCS receive local fault (3x0008.10) = 1)
 * OR (PCS transmit local fault (3x0008.11) = 1)
 *
 ...
 * \brief
 * (COR) Error counter
 *	     This is the 16-bit test pattern counter defined by IEEE.
 *	     The counter is Cleared upon read of this register.
 *	     There is a 32-bit version of this counter at 3x8007, 3x8008.
 *	     If reading the 32-bit version, read 3x8008, followed by
 * 3x8007.
 *	     A read of 3x8007 or 3x002B will clear all 32 bits of the
 * counter
 *
 * \details 
...
/** 
 * \brief
 * (COR) Lower 16 bits of 32-bit version of PCS_ERR_CNT (3x002B)
 *	     This register should only be read directly after reading
 * 3x8008
 *	     Upon read of this register or 3x002B, all 32 bits of the
 * counter are cleared
 *
 * \details 
...
/** 
 * \brief
 * (COR) Upper 16 bits of 32-bit version of PCS_ERR_CNT (3x002B)
 *	     This register should be read, followed immediately by 3x8007
 *	     Upon read of 3x8007 or 3x002B, all 32 bits of the counter are
 * cleard
 *
 * \details 
...
/** 
 * \brief
 * Result of comparing TX sequencing error count (1x8010) to the threshold
 * setting in 3x8E04.
 *
 * \details 
 * 0: count did not exceed threshold setting
...
/** 
 * \brief
 * Result of comparing RX sequencing error count (1x8011) to the threshold
 * setting in 3x8E05.
 *
 * \details 
 * 0: count did not exceed threshold setting
...
/** 
 * \brief
 * Result of comparing TX block encode error count (1x8012) to the
 * threshold setting in 3x8E06.
 *
 * \details 
 * 0: count did not exceed threshold setting
 * 1: count exceeded threshold setting
...
/** 
 * \brief
 * Result of comparing RX block encode error count (1x8013) to the
 * threshold setting in 3x8E07.
 *
 * \details 
 * 0: count did not exceed threshold setting
 * 1: count exceeded threshold setting
...
/** 
 * \brief
 * Result of comparing TX character encode error count (1x8014) to the
 * threshold setting in 3x8E08.
 *
 * \details 
 * 0: count did not exceed threshold setting
 * 1: count exceeded threshold setting
...
/** 
 * \brief
 * Result of comparing RX character encode error count (1x8015) to the
 * threshold setting in 3x8E09.
 *
 * \details 
 * 0: count did not exceed threshold setting
 * 1: count exceeded threshold setting
