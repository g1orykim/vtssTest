...
#ifndef _VOICE_VLAN_CLI_H_
#define _VOICE_VLAN_CLI_H_

/**
 * \file voice_vlan_cli.h
 * \brief This file defines the interface to the Voice VLAN module's CLI commands.
 */
