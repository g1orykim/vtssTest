 ...
 *
 * Field: VTSS_HOST_MAC_CONFIG_MAC_LFS_CFG . LFS_INH_TX
 */
#define  VTSS_F_HOST_MAC_CONFIG_MAC_LFS_CFG_LFS_INH_TX  VTSS_BIT(8)
 ...
 *
 * Field: VTSS_HOST_MAC_CONFIG_MAC_LFS_CFG . LFS_DIS_TX
 */
#define  VTSS_F_HOST_MAC_CONFIG_MAC_LFS_CFG_LFS_DIS_TX  VTSS_BIT(4)
 ...
 * '1': Enable padding.
 *
 * Field: VTSS_HOST_MAC_CONFIG_MAC_PKTINF_CFG . ENABLE_RX_PADDING
 */
#define  VTSS_F_HOST_MAC_CONFIG_MAC_PKTINF_CFG_ENABLE_RX_PADDING  VTSS_BIT(26)
 ...
 *
 * Field: VTSS_HOST_MAC_CONFIG_MAC_PKTINF_CFG . MACSEC_BYPASS_NUM_PTP_STALL_CLKS
 */
#define  VTSS_F_HOST_MAC_CONFIG_MAC_PKTINF_CFG_MACSEC_BYPASS_NUM_PTP_STALL_CLKS(x)  VTSS_ENCODE_BITFIELD(x,28,3)
#define  VTSS_M_HOST_MAC_CONFIG_MAC_PKTINF_CFG_MACSEC_BYPASS_NUM_PTP_STALL_CLKS     VTSS_ENCODE_BITMASK(28,3)
#define  VTSS_X_HOST_MAC_CONFIG_MAC_PKTINF_CFG_MACSEC_BYPASS_NUM_PTP_STALL_CLKS(x)  VTSS_EXTRACT_BITFIELD(x,28,3)
