...
static vtss_rc atom_download_8051_code(
    vtss_state_t *vtss_state,
    vtss_port_no_t port_no, u8 const *code_array, u16 code_size)
{
    u16 i;

    VTSS_D("atom_download_8051_code port:%d, code_size:%d ", port_no, code_size);
...
vtss_rc vtss_phy_is_8051_crc_ok_private(
    vtss_state_t *vtss_state,
    vtss_port_no_t port_no, u16 start_addr, u16 code_length, u16 expected_crc)
{
...
static vtss_rc atom_8051_patch_13_10_2010(vtss_state_t *vtss_state, vtss_port_no_t port_no)
{
    ...
    VTSS_RC(atom_download_8051_code(vtss_state, port_no, &vga_arr[0], sizeof(vga_arr)));
    return VTSS_RC_OK;
}
...
static vtss_rc luton26_atom12_revB_patch(vtss_state_t *vtss_state, vtss_port_no_t port_no)
{
    ...
    VTSS_RC(atom_download_8051_code(vtss_state, port_no, &patch_arr[0], sizeof(patch_arr)));
...
static vtss_rc tesla_revB_8051_patch(vtss_state_t *vtss_state, vtss_port_no_t port_no)
{
    ...
    VTSS_RC(PHY_WR_PAGE(vtss_state, port_no, VTSS_PHY_GPIO_0, 0x4018));     // Enable 8051 clock; no longer indicate patch present; disable PRAM clock override and addr. auto-incr; operate at 125 MHz
    VTSS_RC(PHY_WR_PAGE(vtss_state, port_no, VTSS_PHY_GPIO_0, 0xc018));     // Release 8051 SW Reset
