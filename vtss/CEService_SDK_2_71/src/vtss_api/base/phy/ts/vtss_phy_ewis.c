...
#define VTSS_PHY_EWIS_MMD_READ(port_no, mmd, addr, value)             VTSS_RC(vtss_state->init_conf.mmd_read(vtss_state, port_no, mmd, addr, value))
#define VTSS_PHY_EWIS_MMD_WRITE(port_no, mmd, addr, value)            VTSS_RC(vtss_state->init_conf.mmd_write(vtss_state, port_no, mmd, addr, value))
