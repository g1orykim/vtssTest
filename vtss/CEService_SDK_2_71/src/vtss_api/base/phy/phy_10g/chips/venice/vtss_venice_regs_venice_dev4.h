...
/** 
 * \brief
 * PHY XS fault status. Asserted when either
 * PHY_XS_Status_2:FAULT_RX(4x0008.10) or PHY_XS_Status_2:FAULT_TX
 * (4x0008.11) are asserted.
 *
 * \details 
 ...
 *
 * \details 
 * 0: PHY XS transmit link is down (4x0018.12 = 0)
 * 1: PHY XS transmit link is up (4x0018.12 = 1) 
 *
 ...
 *
 * \details 
 * 0: No fault condition.  XGXS lanes are aligned, 4x0018.12=1.i No Tx FIFO
 * underflow/overflow condition.
 * 1: Fault condition.	XGXS lanes are not aligned, 4x0018.12=0, or Tx FIFO
 * had underflow/overflow condition. 
 *
...
/** 
 * \brief SERDES6G GP CFGA
 *
 * \details
 * General purpose register A
 *
 * Register: \a VENICE_DEV4:SERDES6G_ANA_CFG:SERDES6G_GP_CFGA
 */
 ...
 *
 * \details 
 * Field: VTSS_VENICE_DEV4_SERDES6G_ANA_CFG_SERDES6G_GP_CFGA . GP_MSB
 */
#define  VTSS_F_VENICE_DEV4_SERDES6G_ANA_CFG_SERDES6G_GP_CFGA_GP_MSB(x)  VTSS_ENCODE_BITFIELD(x,0,16)
#define  VTSS_M_VENICE_DEV4_SERDES6G_ANA_CFG_SERDES6G_GP_CFGA_GP_MSB     VTSS_ENCODE_BITMASK(0,16)
#define  VTSS_X_VENICE_DEV4_SERDES6G_ANA_CFG_SERDES6G_GP_CFGA_GP_MSB(x)  VTSS_EXTRACT_BITFIELD(x,0,16)
