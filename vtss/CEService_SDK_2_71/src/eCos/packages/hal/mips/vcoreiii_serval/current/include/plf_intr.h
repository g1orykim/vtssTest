...
//
// Author(s):    lpovlsen
// Contributors: (based on VCoreIII code)
// Date:         2011-12-07
...
#define CYGNUM_HAL_INTERRUPT_DEV_ALL       PRI_ICPU_IRQ0(0)
#define CYGNUM_HAL_INTERRUPT_EXT0          PRI_ICPU_IRQ0(1)
#define CYGNUM_HAL_INTERRUPT_EXT1          PRI_ICPU_IRQ0(2)
#define CYGNUM_HAL_INTERRUPT_TIMER0        PRI_ICPU_IRQ0(3)
#define CYGNUM_HAL_INTERRUPT_TIMER1        PRI_ICPU_IRQ0(4)
#define CYGNUM_HAL_INTERRUPT_TIMER2        PRI_ICPU_IRQ0(5)
#define CYGNUM_HAL_INTERRUPT_UART          PRI_ICPU_IRQ0(6)
#define CYGNUM_HAL_INTERRUPT_UART2         PRI_ICPU_IRQ0(7)
#define CYGNUM_HAL_INTERRUPT_TWI           PRI_ICPU_IRQ0(8)
#define CYGNUM_HAL_INTERRUPT_SW0           PRI_ICPU_IRQ0(9)
#define CYGNUM_HAL_INTERRUPT_SW1           PRI_ICPU_IRQ0(10)
#define CYGNUM_HAL_INTERRUPT_SGPIO         PRI_ICPU_IRQ0(11)
#define CYGNUM_HAL_INTERRUPT_GPIO          PRI_ICPU_IRQ0(12)
#define CYGNUM_HAL_INTERRUPT_MIIM0_INTR    PRI_ICPU_IRQ0(13)
#define CYGNUM_HAL_INTERRUPT_MIIM1_INTR    PRI_ICPU_IRQ0(14)
#define CYGNUM_HAL_INTERRUPT_FDMA          PRI_ICPU_IRQ0(15)
#define CYGNUM_HAL_INTERRUPT_OAM_MEP       PRI_ICPU_IRQ0(16)
#define CYGNUM_HAL_INTERRUPT_PTP_RDY       PRI_ICPU_IRQ0(17)
#define CYGNUM_HAL_INTERRUPT_PTP_SYNC      PRI_ICPU_IRQ0(18)
#define CYGNUM_HAL_INTERRUPT_INTEGRITY     PRI_ICPU_IRQ0(19)
#define CYGNUM_HAL_INTERRUPT_XTR_RDY0      PRI_ICPU_IRQ0(20)
#define CYGNUM_HAL_INTERRUPT_XTR_RDY1      PRI_ICPU_IRQ0(21)
#define CYGNUM_HAL_INTERRUPT_INJ_RDY0      PRI_ICPU_IRQ0(22)
#define CYGNUM_HAL_INTERRUPT_INJ_RDY1      PRI_ICPU_IRQ0(23)
#define CYGNUM_HAL_INTERRUPT_PCIE          PRI_ICPU_IRQ0(24)

/* Indexed IRQs */
#define CYGNUM_HAL_INTERRUPT_TIMER(_tmr_)  (CYGNUM_HAL_INTERRUPT_TIMER0 + (_tmr_))
...
#define CYGNUM_HAL_ISR_MAX                 CYGNUM_HAL_INTERRUPT_PCIE
