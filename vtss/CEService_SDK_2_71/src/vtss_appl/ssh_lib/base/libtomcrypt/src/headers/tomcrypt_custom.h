...
// A lot of modules now depend on tomcrypt.h, so we could either globally add
// DROPBEAR_ECOS to INCLUDE flags, or make every module define it, or simply
// enforce it, since we're only running eCos. I've chosen the latter, though
