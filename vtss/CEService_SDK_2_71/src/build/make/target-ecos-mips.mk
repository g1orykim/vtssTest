...
ACTUAL_CFLAGS := $(filter-out -fno-rtti -Woverloaded-virtual,$(ECOS_GLOBAL_CFLAGS) -Wno-pointer-sign)
#ACTUAL_CXXFLAGS := $(filter-out -Wundef -Wno-unused-but-set-variable -Wno-strict-aliasing -Wno-enum-compare,$(ECOS_GLOBAL_CFLAGS))
ACTUAL_CXXFLAGS := $(filter-out -Wstrict-prototypes -Wno-unused-but-set-variable -Wno-strict-aliasing -Wno-enum-compare,$(ECOS_GLOBAL_CFLAGS))
