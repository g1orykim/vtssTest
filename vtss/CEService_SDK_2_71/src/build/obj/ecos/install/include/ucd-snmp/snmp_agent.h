...
struct agent_snmp_session {
    ...
    struct snmp_pdu      *pdu;
    struct snmp_pdu      *orig_pdu; /* peter, 2007/7, upgrade to new version 1.17.2.1 */
    int		rw;
    int		exact;
    int		status;
    int		index; /* peter, 2007/7, upgrade to new version 1.17.2.1 */
...
/* peter, 2007/7, upgrade to new version 1.17.2.1 */
...
int init_master_agent_v6(int dest_port,
                       int (*pre_parse) (struct snmp_session *, snmp_ipaddr),
                       int (*post_parse) (struct snmp_session *, struct snmp_pdu *,int));
