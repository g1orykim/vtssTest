 ...
 * I2C Slave ID
 *
 * Register: \a SFP_I2C:SFP_I2C_CFG:SLAVE_ID
 */
#define VTSS_SFP_I2C_SFP_I2C_CFG_SLAVE_ID    VTSS_IOREG(0x01, 0, 0xc000)
 ...
 *
 * \details 
 * Field: VTSS_SFP_I2C_SFP_I2C_CFG_SLAVE_ID . SLAVE_ID
 */
#define  VTSS_F_SFP_I2C_SFP_I2C_CFG_SLAVE_ID_SLAVE_ID(x)  VTSS_ENCODE_BITFIELD(x,0,7)
#define  VTSS_M_SFP_I2C_SFP_I2C_CFG_SLAVE_ID_SLAVE_ID     VTSS_ENCODE_BITMASK(0,7)
#define  VTSS_X_SFP_I2C_SFP_I2C_CFG_SLAVE_ID_SLAVE_ID(x)  VTSS_EXTRACT_BITFIELD(x,0,7)
 ...
 *
 * Register: \a SFP_I2C:SFP_I2C_CFG:PRESACLE
 */
#define VTSS_SFP_I2C_SFP_I2C_CFG_PRESACLE    VTSS_IOREG(0x01, 0, 0xc001)
 ...
 *
 * \details 
 * Field: VTSS_SFP_I2C_SFP_I2C_CFG_PRESACLE . PRESCALE
 */
#define  VTSS_F_SFP_I2C_SFP_I2C_CFG_PRESACLE_PRESCALE(x)  VTSS_ENCODE_BITFIELD(x,0,16)
#define  VTSS_M_SFP_I2C_SFP_I2C_CFG_PRESACLE_PRESCALE     VTSS_ENCODE_BITMASK(0,16)
#define  VTSS_X_SFP_I2C_SFP_I2C_CFG_PRESACLE_PRESCALE(x)  VTSS_EXTRACT_BITFIELD(x,0,16)
