...
#ifndef UCD_SNMP_CONFIG_H
#define UCD_SNMP_CONFIG_H
...
/* peter, 2007/6, modified for EstaX-34 compiler error
#include <system.h> */
#include "system.h"

#include <network.h>

/* peter, 2012/6, Enable SNMPv3 AES Privacy Protocol */
#define HAVE_AES

/* Sgetz, 2012/7  */
#define HAVE_MULTI_TRAP_DEST

#endif /* UCD_SNMP_CONFIG_H */
