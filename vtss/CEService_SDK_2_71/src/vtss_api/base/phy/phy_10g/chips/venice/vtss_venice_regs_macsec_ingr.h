...
/** 
 * \details 
 * 1b: Check packet number is non-zero (default)
 *
...
/** 
 * \brief
 * Fixed latency forcing value for the MACsec core, in range 8 to 63 module
 * clock cycles. Streaming out of a packet is blocked for this number of
 * clock cycles after it starts streaming into the MACsec core. An
 * out-of-range value or backpressure from the MAC side (temporarily)
 * disables latency fixing. Normally, this value is set to just above the
 * maximum latency of the operations to be performed.
 * Do not set this value above 26 when setting the static_bypass bit to 1b. 
 *
 * \details 
 ...
 */
#define  VTSS_F_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_DEBUG1_SA_INCREMENT_MASK(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_DEBUG1_SA_INCREMENT_MASK     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_DEBUG1_SA_INCREMENT_MASK(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define  VTSS_F_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_DEBUG3_GLOBAL_INCREMENT_MASK(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_DEBUG3_GLOBAL_INCREMENT_MASK     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_DEBUG3_GLOBAL_INCREMENT_MASK(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_INCEN1_SA_INCREMENT_ENABLE(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_INCEN1_SA_INCREMENT_ENABLE     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_INCEN1_SA_INCREMENT_ENABLE(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define  VTSS_F_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_INCEN2_GLOBAL_INCREMENT_ENABLE(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_INCEN2_GLOBAL_INCREMENT_ENABLE     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_MACSEC_INGR_CNTR_CTRL_DEBUG_REGS_COUNT_INCEN2_GLOBAL_INCREMENT_ENABLE(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
 ...
 */
#define  VTSS_F_MACSEC_INGR_POST_PROC_CTL_DEBUG_REGS_COUNT_SECFAIL1_SA_SECFAIL_MASK(x)  VTSS_ENCODE_BITFIELD(x,0,11)
#define  VTSS_M_MACSEC_INGR_POST_PROC_CTL_DEBUG_REGS_COUNT_SECFAIL1_SA_SECFAIL_MASK     VTSS_ENCODE_BITMASK(0,11)
#define  VTSS_X_MACSEC_INGR_POST_PROC_CTL_DEBUG_REGS_COUNT_SECFAIL1_SA_SECFAIL_MASK(x)  VTSS_EXTRACT_BITFIELD(x,0,11)
 ...
 */
#define  VTSS_F_MACSEC_INGR_POST_PROC_CTL_DEBUG_REGS_COUNT_SECFAIL2_GLOBAL_SECFAIL_MASK(x)  VTSS_ENCODE_BITFIELD(x,0,14)
#define  VTSS_M_MACSEC_INGR_POST_PROC_CTL_DEBUG_REGS_COUNT_SECFAIL2_GLOBAL_SECFAIL_MASK     VTSS_ENCODE_BITMASK(0,14)
#define  VTSS_X_MACSEC_INGR_POST_PROC_CTL_DEBUG_REGS_COUNT_SECFAIL2_GLOBAL_SECFAIL_MASK(x)  VTSS_EXTRACT_BITFIELD(x,0,14)
