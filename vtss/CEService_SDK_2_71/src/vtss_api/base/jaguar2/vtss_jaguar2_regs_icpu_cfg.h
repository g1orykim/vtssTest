 ...
 * \brief
 * The default value of this field depends on strapping of the VCore.
 * Select the owner of the dedicated SI interface.
 * Please note, if the SI slave is not owner of this interface, it is not
 * possible for an external CPU to access registers in the chip via the
 * didicated SI interface.
 *
 * \details 
 * 00 : SI Slave
 * 01 : SPI Boot Master
 * 10 : SPI Master
 *
 * Field: ::VTSS_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL . IF_SI0_OWNER
 */
...
/** 
 * \brief
 * Select the owner of the GPIO overlayed SI interface.
 ...
 *
 * \details 
 * Field: ::VTSS_ICPU_CFG_CPU_SYSTEM_CTRL_GENERAL_CTRL . SSI_MST_CONTENTION
 */
 ...
 * MEMCTRL_ZCAL:ZCAL_ENA to be broken. That is; when this field is set
...
/** 
 * \brief
 * Set to force override value MEMCTRl_ZCAL_OVR:ZCAL_OVR_ZCTRL instead of
