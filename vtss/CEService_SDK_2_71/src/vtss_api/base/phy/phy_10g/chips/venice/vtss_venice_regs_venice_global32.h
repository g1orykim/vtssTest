 ...
 * 1 (ranges from 0 (20mV) to 127 (340mV), suggested default is 40
 * (220mV)).
 *
...
/** 
 * \brief
 * Level offset (6bit-signed) compared to IB_EQ_LD1_LEVEL for Level-Detect
 * circuitry 1. Saturating between 20mV and 340mV. See also note in
...
/** 
 * \brief
 * Level for Level-Detect circuitry 0 (ranges from 0 (20mV) to 127 (340mV),
 * suggested default is 40 (220mV))
 *
 * \details 
...
/** 
 * \brief
 * Threshold value for IE Signal-Detect (ranges from 0 (20mV) to 127
 * (340mV), suggested default is 2)
 *
 * \details 
...
/** 
 * \brief
 * Block select for offset correction of IS-stage of Input Buffer (MSB not
 * used)
 *
 * \details 
...
/** 
 * \brief
 * Calibration control for IA/IS
 *
 * \details 
 * 0: -offset-max/threshold-2%
 * 31: -offset-0/threshold-48%
 * 32: +offset-0/threshold-52%
 * 63: +offset-max/threshold-98%
 *
...
/** 
 * \brief
 * Selects higher or lower DFE offset for IS calibration 0:
 * ib_dfe_offset_l, 1: ib_dfe_offset_h
 *
 * \details 
 ...
 *
 * \details
 * Configuration register for Service-Bus related setting
 *
...
/** 
 * \brief F2DF_RX subversion revision number
 *
 * \details
 * Subversion revision number for the RTL used in F2DF_RX
 *
 * Register: \a VENICE_GLOBAL32:F2DF_IB:F2DF_RX_SVN_ID
 */
#define VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_SVN_ID  VTSS_IOREG(0x1e, 1, 0xf02d)


/** 
 * \brief F2DF_RX Revision ID
 *
 * \details
 * Revision numbers of the analog sub IPs used in the F2DF_RX
 *
 * Register: \a VENICE_GLOBAL32:F2DF_IB:F2DF_RX_REV_ID
 */
#define VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID  VTSS_IOREG(0x1e, 1, 0xf02e)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID . DES_REV_ID
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_DES_REV_ID(x)  VTSS_ENCODE_BITFIELD(x,26,6)
#define  VTSS_M_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_DES_REV_ID     VTSS_ENCODE_BITMASK(26,6)
#define  VTSS_X_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_DES_REV_ID(x)  VTSS_EXTRACT_BITFIELD(x,26,6)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID . IB_REV_ID
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_IB_REV_ID(x)  VTSS_ENCODE_BITFIELD(x,20,6)
#define  VTSS_M_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_IB_REV_ID     VTSS_ENCODE_BITMASK(20,6)
#define  VTSS_X_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_IB_REV_ID(x)  VTSS_EXTRACT_BITFIELD(x,20,6)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID . SYNTH_REV_ID
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_SYNTH_REV_ID(x)  VTSS_ENCODE_BITFIELD(x,14,6)
#define  VTSS_M_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_SYNTH_REV_ID     VTSS_ENCODE_BITMASK(14,6)
#define  VTSS_X_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_SYNTH_REV_ID(x)  VTSS_EXTRACT_BITFIELD(x,14,6)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID . RCPLL_REV_ID
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_RCPLL_REV_ID(x)  VTSS_ENCODE_BITFIELD(x,8,6)
#define  VTSS_M_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_RCPLL_REV_ID     VTSS_ENCODE_BITMASK(8,6)
#define  VTSS_X_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_RCPLL_REV_ID(x)  VTSS_EXTRACT_BITFIELD(x,8,6)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID . TOP_REV_ID
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_TOP_REV_ID(x)  VTSS_ENCODE_BITFIELD(x,0,8)
#define  VTSS_M_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_TOP_REV_ID     VTSS_ENCODE_BITMASK(0,8)
#define  VTSS_X_VENICE_GLOBAL32_F2DF_IB_F2DF_RX_REV_ID_TOP_REV_ID(x)  VTSS_EXTRACT_BITFIELD(x,0,8)
...
/** 
 * \brief
 * Enable for different offset compensation stages: b0 => Synthesizer main
 * rotator; b1 => Feedback buffer; b2 => CDR rotator; b3 => VCO buffer
 *
 * \details 
...
/** 
 * \brief
 * selects feedback divider setting: Coding: 0: divide by 1; 1: divide by
 * 2; 2: divide by 4; 3: prohibited
 *
 * \details 
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0 . SYNTH_FB_DIR
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0_SYNTH_FB_DIR  VTSS_BIT(13)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0 . SYNTH_I2_DIR
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0_SYNTH_I2_DIR  VTSS_BIT(10)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0 . SYNTH_I1_DIR
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0_SYNTH_I1_DIR  VTSS_BIT(7)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0 . SYNTH_P_DIR
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_CFG0_SYNTH_P_DIR  VTSS_BIT(5)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0 . SYNTH_I1_SAT_DET_CLR
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0_SYNTH_I1_SAT_DET_CLR  VTSS_BIT(25)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0 . SYNTH_I1_SAT_DET
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0_SYNTH_I1_SAT_DET  VTSS_BIT(24)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0 . SYNTH_I2_WRAP_INHIBIT
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0_SYNTH_I2_WRAP_INHIBIT  VTSS_BIT(23)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0 . SYNTH_I2_WRAP_DET_CLR
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0_SYNTH_I2_WRAP_DET_CLR  VTSS_BIT(22)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0 . SYNTH_I2_WRAP_DET
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_RX_SYNTH_QUALIFIER0_SYNTH_I2_WRAP_DET  VTSS_BIT(21)
 ...
 */
#define VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT  VTSS_IOREG(0x1e, 1, 0xf048)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT . F2DF_SIDE_DET_STICKY
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT_F2DF_SIDE_DET_STICKY  VTSS_BIT(22)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT . F2DF_TOG_DET_STICKY
 */
#define  VTSS_F_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT_F2DF_TOG_DET_STICKY  VTSS_BIT(10)
 ...
 *
 * \details 
 * Field: VTSS_VENICE_GLOBAL32_F2DF_RX_SYNTH_F2DF_CFG_STAT . F2DF_SAMPLE_MODE
 */
