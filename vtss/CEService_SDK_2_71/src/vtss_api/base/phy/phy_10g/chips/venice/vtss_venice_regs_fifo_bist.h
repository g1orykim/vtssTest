 ...
 * the paths is controlled by 4xEA20.7 and 4xEA20.8.
 *
 ...
 */
#define  VTSS_F_FIFO_BIST_GEN_PKTLEN_GEN_PKTLEN_PKTLEN(x)  VTSS_ENCODE_BITFIELD(x,0,16)
#define  VTSS_M_FIFO_BIST_GEN_PKTLEN_GEN_PKTLEN_PKTLEN     VTSS_ENCODE_BITMASK(0,16)
#define  VTSS_X_FIFO_BIST_GEN_PKTLEN_GEN_PKTLEN_PKTLEN(x)  VTSS_EXTRACT_BITFIELD(x,0,16)
