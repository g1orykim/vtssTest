...
#define JAGUAR_SER_CLOCK          CYGNUM_HAL_MIPS_VCOREIII_AHB_CLOCK
...
static channel_data_t jaguar_channel = {
    VTSS_TO_UART, 2, 1000, CYGNUM_HAL_INTERRUPT_UART,
    (JAGUAR_SER_CLOCK/16/CYGNUM_HAL_VIRTUAL_VECTOR_CHANNELS_DEFAULT_BAUD)
};
                           ...
                           __comm_control_cmd_t __func, ...)
{
    ...
    case __COMMCTL_SETBAUD:
    {
        ...
        baud_divisor = (JAGUAR_SER_CLOCK / 16 / baud_rate);
