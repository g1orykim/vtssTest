...
static const i32 latency_igr[SPEED_INDEX_MAX] = {
    [SPEED_INDEX_10M]   = 86+115,
    [SPEED_INDEX_100M]  = 86+115, /* I have added 115 ns compared to the values given by HW in order to obtain the correct path delay */
    [SPEED_INDEX_1000M] = 86+20,  /* I have added 20 ns compared to the values given by HW in order to obtain the correct path delay */
    [SPEED_INDEX_2500M] = 35+12   /* I have added 12 ns compared to the values given by HW in order to obtain the correct path delay */
};

static const i32 latency_egr[SPEED_INDEX_MAX] = {
    [SPEED_INDEX_10M]   = 776+115, /* the correct value is 7256, but this is outside the latency value range */
    [SPEED_INDEX_100M]  = 776+115, /* I have added 115 ns compared to the values given by HW in order to obtain the correct path delay */
    [SPEED_INDEX_1000M] = 136+20,  /* I have added 20 ns compared to the values given by HW in order to obtain the correct path delay */
    [SPEED_INDEX_2500M] = 54+12    /* I have added 12 ns compared to the values given by HW in order to obtain the correct path delay */
};
...
/*
* set port speed in the timestamp API (used to compensate for the internal ingress ane egress latencies)
*/
                                     ...
                                     vtss_port_speed_t      speed)
{
    ...
    if (speed_index < SPEED_INDEX_MAX) {
        ...
        rc = srvl_ts_egress_latency_set(vtss_state, port_no);
    } else {
        VTSS_E("invalid port speed %d", port_no);
        rc = VTSS_RC_ERROR;
    }
    return rc;
}
