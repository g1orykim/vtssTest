...
// Cache operational mode, The HAL_CACHE_CONFIG_K0_VAL (on a MIPS 24K)
// is encoded as follows:
//   0 = cache-enabled, write-through, no write-allocate.
//   3 = cache-enabled, write-back, write-allocate. (Preferred!)
// We enable write-through "MM" (bit 18) with write-back
